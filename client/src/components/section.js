...
const Section = () => {
  return (
    <div className="section">
      <h1>Categories</h1>
      <div className="boxes">
        <div className="box" style={{backgroundColor:"#E13300"}}>
            <h2>Trending</h2>
            <div className="image">
                <img src={Trending} alt="trend" />
            </div>
        </div>
        <div className="box" style={{backgroundColor:"#7358FF"}}>
            <h2>Chill</h2>
            <div className="image">
                <img src={Chill} alt="rbrt" />
            </div>
        </div>
        <div className="box" style={{backgroundColor:"#1E3264"}}>
            <h2>English</h2>
            <div className="image">
                <img src={English} alt="trend" />
            </div>
        </div>
        <div className="box" style={{backgroundColor:"#E8125C"}} >
            <h2>Tamil</h2>
            <div className="image">
                <img src={Tamil} alt="erhrt" />
            </div>
        </div>
        <div className="box" style={{backgroundColor:"#E9142A"}}>
            <h2>hindi</h2>
            <div className="image">
                <img src={Hindi} alt="trend" />
            </div>
        </div>
        <div className="box" style={{backgroundColor:"#B02897"}}>
            <h2>k-pop</h2>
            <div className="image">
